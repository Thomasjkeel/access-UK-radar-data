...
| ------ | ------- | -------- | --------------- |
| from file | Met Office Rain Radar Data from the NIMROD System | [CEDA Archive](https://catalogue.ceda.ac.uk/uuid/82adec1f896af6169112d09cc1174499/) | [read_NIMROD_data_from_CEDA.ipynb](https://github.com/Thomasjkeel/access-UK-radar-data/blob/main/from_file/read_radar_data_from_CEDA_Archive.ipynb) |
